...
import { officeFn } from "./../officeLogic"
import "./../Office.scss"
...
const ZL = ()=>{
  ...
  //FS query = { "nr.month":unixToDateTimeConverter().month }

  let query = { $or: [ { status:"edited" }, { "nr.month":unixToDateTimeConverter().month } ] }
  useEffect( ()=>{ !table && officeFn(table, setTable, {type:"GET_TABLE", mode, query}) },[])
  ...
  return(
...

    {
      ...
      {/* { table && <ToPast props={{ mode, table, setTable, officeFn }} /> } */}
